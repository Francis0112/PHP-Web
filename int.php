...
?>
		<div class ="container">
			...
			<h2 class="headtitle"> Internationals </h2>
			...
			<!--<h3 class="head3"> [Elsword] - New Promo Trailer </h3>
				...
				<h3 class="head3"> [Elsword] Chung Deadly Chaser Advanced Aircombo __ Improved Aircombo </h3>
				<video class="vds" controls="" poster="sendark.jpg">
					<source src="[Elsword] Chung Deadly Chaser Advanced Aircombo __ Improved Aircombo.mp4">
					</video><p> Check out this new promo trailer for Elsword.</p>
